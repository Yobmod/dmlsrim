...
class AutoTRIM(object):
    def __init__(self, mode: int = 1, restart_directroy: Optional[str] = None) -> None:
...
class TRIMInput(object):
    ...
    def __init__(self, trim: TRIM) -> None:
        self._trim = trim

    @property
    def srim_num_elements(self) -> int:
    ...
    def _write_cascade_options(self) -> str:
        return (
    ...
    def _write_plot_on_off(self) -> str:
        return (
    ...
    def _write_plot_options(self) -> str:
        return (
    ...
    def _write_lattice_binding(self) -> str:
        lattice_str = (
    ...
    def _write_surface_binding(self) -> str:
        surface_str = (
...
class SRInput(object):
    ...
    def __init__(self, sr: SR) -> None:
        self._sr = sr

    def _write_filename(self) -> str:
        return (
    ...
    def _write_layer_info(self) -> str:
        return (
    ...
    def _write_output_options(self) -> str:
        return (
    ...
    def _write_ion_energy_range(self) -> str:
        return (
